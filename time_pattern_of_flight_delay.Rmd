...
* The average delay time across months has a tendency to increase from $January$ to $June$ and peaks at the end of $July$/the beginning of $August$, then it starts to decrease but it reaches to another small peak again at the $end$ of the year (Might because of Christmas holiday). \
* There might be differences on delayed time due to late aircraft across these years, we are then curious about the significance of its difference between 2012 and 2016. 
* Next, we are going to utilize t-test to determine this possible difference.
...
* The p-value of t-test is **0.3588** which is greater than 0.05, which means, with 0.05 significance level, there is no enough evidence to reject that flight delayed by late aircraft is different between 2012 and 2016.
